<template>
    ...
    <div class="relative flex">
        ...
        <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
            <button @click="sendMessage" type="button" class="inline-flex items-center justify-center rounded-full h-12 w-12 transition duration-500 ease-in-out bg-blue-500 hover:bg-blue-400 focus:outline-none">
